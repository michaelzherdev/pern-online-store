        ...
        <Modal show={show} onHide={onHide} centered>
            ...
            <Modal.Body>
                <Form>
                    ...
                    <Form.Control value={price} onChange={e => setPrice(Number(e.target.value))} className="mt-3" placeholder="Price"
                                  type="number"/>
                    <Form.Control className="mt-3" type="file" onChange={selectFile}/>
                    <hr/>
                    <Button variant={"outline-dark"} onClick={addInfo}>Add device</Button>
                    {info.map(i =>
